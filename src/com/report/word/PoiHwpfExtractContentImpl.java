 ...
 */
public class PoiHwpfExtractContentImpl implements IPoiExtractContent<HWPFDocument> {
	 ...
	 * 
	 * @param styleName
	 *            需进行处理的标题样式 ，如"标题 3,标题 3 Char,标题 3 Char Char”
	 * @return
	 */
	...
	public Map<String, String> getInfo(String docPath) {
		try {
			...
			mapInfo.put("createdate", DateUtil.dateToString(info.getCreateDateTime(), "yyyy-MM-dd HH:mm:ss.SSS")); // 创建时间
			mapInfo.put("updatedate", DateUtil.dateToString(info.getLastSaveDateTime(), "yyyy-MM-dd HH:mm:ss.SSS")); // 修改时间
		} catch (Exception e) {
		}
		return null;
	}
